...
wget https://github.com/DaniarSher81212/DiskAnalyzer/releases/download/v1.3.0/disk-analyzer
chmod +x disk-analyzer
./disk-analyzer help

# macOS
wget https://github.com/DaniarSher81212/DiskAnalyzer/releases/download/v1.3.0/disk-analyzer-macos
chmod +x disk-analyzer-macos
./disk-analyzer-macos help

# Windows (PowerShell)
Invoke-WebRequest -Uri "https://github.com/DaniarSher81212/DiskAnalyzer/releases/download/v1.3.0/disk-analyzer.exe" -OutFile disk-analyzer.exe
